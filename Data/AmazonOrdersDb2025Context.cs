...
namespace AOWebApp2.Data;

public partial class AmazonOrdersDb2025Context : DbContext
{
    public AmazonOrdersDb2025Context()
    {
    }

    public AmazonOrdersDb2025Context(DbContextOptions<AmazonOrdersDb2025Context> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=CON_PC\\SQLEXPRESS;Initial Catalog=AmazonOrdersDB2025;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
