...
namespace AOWebApp2.Controllers
{
    ...
    public class ItemsWebAPIController : ControllerBase
    {
        ...
        public ItemsWebAPIController(AmazonOrdersDb2025Context context)
        {
            _context = context;
        }
        ...
        {
            var ItemQuery = _context.Items.OrderBy(i => i.ItemName).AsQueryable();

            //if (SearchText.IsNullOrEmpty() && !CategoryID.HasValue)
            //{
