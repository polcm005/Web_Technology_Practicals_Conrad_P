...
namespace AOWebApp2.Controllers
{
    ...
    public class ParentCategoriesWebAPIController : ControllerBase
    {
        ...
        public ParentCategoriesWebAPIController(AmazonOrdersDb2025Context context)
        {
            _context = context;
        }
        ...
        {
            var CategoryQuery = _context.ItemCategories.Where(i => i.ParentCategoryId == null).OrderBy(i => i.CategoryName);
